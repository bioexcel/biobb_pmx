...
* Installation:
        ...
        conda install -c bioconda "biobb_pmx>=3.0.1"
...
* Installation:
        ...
        docker pull quay.io/biocontainers/biobb_pmx:3.0.1--py_0


* Usage:


        docker run quay.io/biocontainers/biobb_pmx:3.0.1--py_0 <command>
